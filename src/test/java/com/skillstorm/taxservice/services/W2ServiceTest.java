...
class W2ServiceTest {
    ...
    private static W2 newW2;
    private static W2 returnedW2;
    private static List<W2> w2List;
    
    @BeforeEach
    public void setup() {
        w2Service = new W2Service(w2Repository, s3Service);
    ...
    void addW2Test() {
        ...
        //Define stubbing:
        when(w2Repository.saveAndFlush(newW2)).thenReturn(returnedW2);

        //Call the method to test:
        W2 result = w2Service.addW2(newW2);
    ...
    void findByIdSuccessTest() {
        ...
        //Call the method to test:
        W2 result = w2Service.findById(1);
    ...
    void findByIdFailureTest() {
        ...
        //Define stubbing:
        when(w2Repository.findById(1)).thenReturn(java.util.Optional.empty());
    ...
    void findAllByUserIdTest() {
        ...
        //Define stubbing:
        when(w2Repository.findAllByUserId(1)).thenReturn(w2List);

        //Call the method to test:
        List<W2> result = w2Service.findAllByUserId(1);
    ...
    void findAllByUserIdAndYearTest() {
        ...
        //Define stubbing:
        when(w2Repository.findAllByUserIdAndYear(1, 2024)).thenReturn(w2List);

        //Call the method to test:
        List<W2> result = w2Service.findAllByUserIdAndYear(1, 2024);
    ...
    void updateByIdSuccessTest() {
        ...
        //Call the method to test:
        W2 result = w2Service.updateById(1, returnedW2);
